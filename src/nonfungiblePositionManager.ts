...
import INonfungiblePositionManager from '@voltage-finance/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'

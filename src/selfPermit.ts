import { BigintIsh, Token } from '@voltage-finance/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@voltage-finance/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
